...
export default function EditProduct({ params }) {
    ...
    useEffect(() => {
        ...
        const getProduct = async () => {
            const res = await fetch(`http://localhost:3003/productdetail/${id}`);
            const data = await res.json();
            setProduct(data);
    ...
    const onSubmit = async (data) => {
        ...
        const res = await fetch(`http://localhost:3003/updateproduct/${id}`, {
            method: 'PUT',
            body: formData,
        });
        ...
        <div className="m-3">
            ...
            <form onSubmit={handleSubmit(onSubmit)} enctype="multipart/form-data">
                ...
                <div className="form-group my-2">
                    ...
                    <br />
                    <img src={`http://localhost:3003/img/${product?.image}`} width='200px' />
